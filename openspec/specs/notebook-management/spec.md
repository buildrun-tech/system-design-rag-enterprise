...
Prover CRUD de notebooks — a unidade lógica de agrupamento de sources pertencentes a um usuário — garantindo que cada usuário só acesse e gerencie seus próprios notebooks, e que a deleção de um notebook remova em cascata todos os dados associados (sources, chunks, conversas).
