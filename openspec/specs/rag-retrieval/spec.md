...
Prover a recuperação semântica de chunks via pgvector (similarity search), filtrada por notebook e pelas sources selecionadas pelo usuário na conversa, e a montagem do prompt final enviado ao LLM combinando contexto recuperado, histórico de conversa e a mensagem atual do usuário.
